...
const bioData: IBioData = {
  aboutMe: [
    ...
    'I like to take ownership of the work that I’m assigned and give my best to deliver it on time. I like to solve challenges and keep myself up to date with the cutting edge technologies.',
  ],
...
const skillTags: SkillTags = [
  { id: 1, name: 'JavaScript', backgroundColor: 'yellow', fontColor: '#000' },
  { id: 2, name: 'Es6+', backgroundColor: 'yellow', fontColor: '#000' },
  { id: 3, name: 'TypeScript', backgroundColor: 'blue', fontColor: '#000' },
  { id: 4, name: 'React Js', backgroundColor: 'blue', fontColor: '#000' },
  { id: 5, name: 'Redux', backgroundColor: 'blue', fontColor: '#000' },
  { id: 6, name: 'Next Js', backgroundColor: 'blue', fontColor: '#000' },
  { id: 7, name: 'Meteor Js', backgroundColor: 'blue', fontColor: '#000' },
  { id: 8, name: 'Web Sockets', backgroundColor: 'blue', fontColor: '#000' },
  { id: 9, name: 'Node Js', backgroundColor: 'blue', fontColor: '#000' },
  { id: 10, name: 'Express', backgroundColor: 'blue', fontColor: '#000' },
  { id: 11, name: 'MongoDB', backgroundColor: 'blue', fontColor: '#000' },
  { id: 12, name: 'GraphQL', backgroundColor: 'blue', fontColor: '#000' },
  { id: 13, name: 'Firebase', backgroundColor: 'blue', fontColor: '#000' },
  { id: 14, name: 'Docker', backgroundColor: 'blue', fontColor: '#000' },
  { id: 15, name: 'CI/CD', backgroundColor: 'blue', fontColor: '#000' },
  { id: 16, name: 'HTML', backgroundColor: 'blue', fontColor: '#000' },
  { id: 17, name: 'CSS', backgroundColor: 'blue', fontColor: '#000' },
  { id: 18, name: 'Sass', backgroundColor: 'blue', fontColor: '#000' },
  {
    id: 19,
